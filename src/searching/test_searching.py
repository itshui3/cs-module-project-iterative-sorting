...
class SearchingTests(unittest.TestCase):
    ...
    def test_binary_search(self):
        ...
        self.assertEqual(re_binary_search(arr1, -8), 1)
        self.assertEqual(re_binary_search(arr1, 0), 6)
        self.assertEqual(re_binary_search(arr2, 6), -1)
        self.assertEqual(re_binary_search(arr2, 0), -1)
